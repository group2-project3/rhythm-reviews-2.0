            ...
            <ul>
              {reviews.map((review) => (
                <li key={review.dataValues.id} className="p-2.5 rounded border-2 mb-5 bg-white album-review" data-review-id={review.dataValues.id}>
                  ...
                  <div>
                    <div
                      id={`update-review-form-${dataValues.id}`}
                      className="hidden"
                    >
                      <input
                        id={`review-title-${dataValues.id}`}
                        type="text"
                      ...
                      />
                      <textarea
                        id={`review-content-${dataValues.id}`}
                        maxLength="1000"
                        rows="4"
                      ...
                      <button
                        ...
                        onClick={() => saveUpdatedReview(dataValues.id)}
                      >
                        Save
                      </button>
                      <button
                        id={`cancel-review-${dataValues.id}`}
                        type="button"
                        className="box-border inline-block w-20 px-1 py-1 mt-2 mr-3 text-xs text-white transition-colors duration-300 ease-in-out bg-blue-600 border-2 border-black rounded hover:bg-blue-700 h-51"
                        onClick={() => cancelUpdateReview(dataValues.id)}
                      >
                        Cancel
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      id={`update-review-${dataValues.id}`}
                      type="button"
                      className="box-border inline-block w-20 px-1 py-1 mt-2 mr-3 text-xs text-white transition-colors duration-300 ease-in-out bg-blue-600 border-2 border-black rounded hover:bg-blue-700 h-51"
                      onClick={(event) =>
                        showUpdateFields(event, dataValues.id)
                      }
                    >
                      Update
                    </button>
